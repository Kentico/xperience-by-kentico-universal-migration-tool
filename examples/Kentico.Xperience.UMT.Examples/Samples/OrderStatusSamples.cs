...
public static class OrderStatusSamples
{
    ...
    [Sample("orderstatus.sample.processing", "Sample demonstrates how to create a processing order status", "Instance of OrderStatusInfo - Sample processing order status")]
    public static OrderStatusModel SampleOrderStatusProcessing => new()
    {
    ...
    [Sample("orderstatus.sample.completed", "Sample demonstrates how to create a completed order status", "Instance of OrderStatusInfo - Sample completed order status")]
    public static OrderStatusModel SampleOrderStatusCompleted => new()
    {
        ...
        OrderStatusOrder = 3,
        OrderStatusInternalNotificationEnabled = true,
        OrderStatusCustomerNotificationEnabled = false
    };
}
