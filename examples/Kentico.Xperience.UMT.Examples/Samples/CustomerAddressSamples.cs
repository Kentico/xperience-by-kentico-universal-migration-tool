...
public static class CustomerAddressSamples
{
    ...
    [Sample("customeraddress.sample.basic", "Sample demonstrates how to create a customer address", "Instance of dataclass CustomerAddressInfo - Sample customer address")]
