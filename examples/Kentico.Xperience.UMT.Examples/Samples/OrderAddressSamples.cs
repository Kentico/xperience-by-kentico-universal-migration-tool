...
public static class OrderAddressSamples
{
    ...
    [Sample("orderaddress.sample.billing", "Sample demonstrates how to create a billing address for an order", "Instance of dataclass OrderAddressInfo - Sample billing address")]
    ...
    [Sample("orderaddress.sample.shipping", "Sample demonstrates how to create a shipping address for an order", "Instance of dataclass OrderAddressInfo - Sample shipping address")]
