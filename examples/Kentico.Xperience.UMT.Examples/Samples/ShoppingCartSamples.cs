...
public static class ShoppingCartSamples
{
    ...
    [Sample("shoppingcart.sample.anonymous", "Sample demonstrates how to create an anonymous shopping cart", "Instance of ShoppingCartInfo - Sample anonymous shopping cart")]
