...
public static class CustomerSamples
{
    ...
    [Sample("customer.sample.withmember", "Sample demonstrates how to create a customer with member reference", "Instance of CustomerInfo - Sample customer with member")]
    public static CustomerModel SampleCustomerWithMember => new()
    {
        CustomerGUID = SAMPLE_CUSTOMER_WITH_MEMBER_GUID,
