...
internal class AdapterFactory
{
    ...
    internal IInfoAdapter<IUmtModel>? CreateAdapter(IUmtModel umtModel, IProviderProxyContext providerProxyContext) =>
        umtModel switch
        {
            ...
            WebPageAclModel => new GenericInfoAdapter<WebPageAclInfo>(loggerFactory.CreateLogger<GenericInfoAdapter<WebPageAclInfo>>(), modelService, providerProxyFactory.CreateProviderProxy<WebPageAclInfo>(providerProxyContext), providerProxyFactory),
            WebPageAclMappingModel => new GenericInfoAdapter<WebPageAclMappingInfo>(loggerFactory.CreateLogger<GenericInfoAdapter<WebPageAclMappingInfo>>(), modelService, providerProxyFactory.CreateProviderProxy<WebPageAclMappingInfo>(providerProxyContext), providerProxyFactory),
