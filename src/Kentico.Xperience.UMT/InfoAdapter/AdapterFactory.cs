...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            CustomerModel => new CustomerAdapter(loggerFactory.CreateLogger<CustomerAdapter>(), adapterContext),
            CustomerAddressModel => new CustomerAddressAdapter(loggerFactory.CreateLogger<CustomerAddressAdapter>(), adapterContext),
            OrderModel => new OrderAdapter(loggerFactory.CreateLogger<OrderAdapter>(), adapterContext),
            OrderItemModel => new OrderItemAdapter(loggerFactory.CreateLogger<OrderItemAdapter>(), adapterContext),
            OrderAddressModel => new OrderAddressAdapter(loggerFactory.CreateLogger<OrderAddressAdapter>(), adapterContext),
            OrderStatusModel => new OrderStatusAdapter(loggerFactory.CreateLogger<OrderStatusAdapter>(), adapterContext),
            ShippingMethodModel => new ShippingMethodAdapter(loggerFactory.CreateLogger<ShippingMethodAdapter>(), adapterContext),
            PaymentMethodModel => new PaymentMethodAdapter(loggerFactory.CreateLogger<PaymentMethodAdapter>(), adapterContext),
            OrderStatusNotificationModel => new OrderStatusNotificationAdapter(loggerFactory.CreateLogger<OrderStatusNotificationAdapter>(), adapterContext),
            ShoppingCartModel => new ShoppingCartAdapter(loggerFactory.CreateLogger<ShoppingCartAdapter>(), adapterContext),
